// ifelse_test_20130926.c - demonstration how if - else statements work
...
{
  if (my_testvar1_ >= 0) printf("my_testvar1_ >= 0\n" );
  else
    printf("my_testvar1_ < 0\n");
  // a more complex condition:
  if ((my_testvar1_ < my_testvar2_)&& (my_testvar2_ < my_testvar3_))
  ...
  if (my_testvar1_ < my_testvar2_)
  {
    if (my_testvar2_ < my_testvar3_)
      printf("my_testvar2_ also lies between the others\n");
  }
  ...
  else
  {
    ...
    if(my_testvar1_ == 0) printf("and it is zero\n");
    else
    {
      if(my_testvar1_ < 0) printf("and it is negative\n");
      else
        printf("and it is positive\n");
    }
  }
